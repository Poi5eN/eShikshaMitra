            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-2 ">
              ...
              {/* <div className="w-full px-4 lg:w-1/2 xl:w-6/12 md:mx-auto sm:mx-auto"> */}
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <div id="text" class="md:text-2xl text-center uppercase bg-clip-text text-transparent bg-gradient-to-r from-green-300 via-blue-500 to-[#0e7490] text-5xl font-black py-5"> GET IN TOUCH WITH US</div>
              ...
              <div className="w-full md:px-20">
                <div className="relative p-2 bg-white rounded-lg shadow-lg sm:p-8">
                  <form onSubmit={handleSubmitCreate}>
                    ...
                    <div>
                      <button
                        type="submit"
                        class="w-full p-3 text-white bg-cyan-600  transition border rounded border-primary
