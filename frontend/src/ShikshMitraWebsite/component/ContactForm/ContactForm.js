    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          ...
          <div class="app-contact">CONTACT INFO : +91 8920377548</div>
        </div>
        <div class="screen-body-item">
          <form class="app-form" onSubmit={handleSubmitCreate}>
            ...
            <div class="app-form-group buttons">
              ...
              <button   type="submit" class="app-form-button">Send message</button>
            </div>
          </form>
        </div>
      </div>
...
//           <div className="right_content  w-[50%]flex items-center justify-center">
//             <form className="home_form" onSubmit={handleSubmitCreate}>
//               <h1 className="home_title text-center mb-4">Talk to Us</h1>
...
//                 <input
                  ...
                  // id="name"
                  // name="name"
                  // className="form-control form-control-lg thick home_input"
                  // placeholder="Name"
                  // value={formData.name}
                  // onChange={handleOnChange}
                  // required
...
//               <div className="form-group message py-2">
//                 <textarea
//                   id="message"
//                   name="message"
//                   className="form-control form-control-lg home_input"
//                   rows="4"
//                   cols="23"
//                   placeholder="Message"
//                   value={formData.message}
